...
const music_graph_descriptors = {
	...
	*/
	...
	supergenre_supercluster: 1400, //Traverse between the same music group(MG): Rap(SGG)->Rhythm Music(MG)->R&B(SGG)
	/*
		Special:
	*/
	...
	*/
	...
	map_colors: [	// Todo: use colorbrewer sequential palettes
		...
		['Jazz',                                '#fb9a99'],
		['Latin',                               '#e31a1c'],
		['New Age subgenres and styles',        '#fdbf6f'],
		['Rap',                                 '#ff7f00'],
		['International',                       '#cab2d6'],
		['R&B',                                 '#6a3d9a'],
		['Reggae',                              '#ffff99'],
		['Stage & Screen',                      '#b15928'],
		['Blues',                               '#a6cee3'],
		...
		['Alternative Country',                 '#a6cee3'],
		['Contemporary Country',                '#1f78b4'],
		['Country-Pop',                         '#b2df8a'],
		['Honky Tonk',                          '#33a02c'],
		['Progressive Country',                 '#fb9a99'],
		['Traditional Country',                 '#e31a1c'],
		['Western Swing',                       '#fdbf6f'],
		['Downtempo',                           '#ff7f00'],
		['Electronica',                         '#cab2d6'],
		['Experimental Electronic',             '#6a3d9a'],
		['House',                               '#ffff99'],
		['Jungle / Drum\u0027n\u0027Bass',      '#b15928'],
		['Techno',                              '#a6cee3'],
		['Trance',                              '#1f78b4'],
		['Contemporary Folk',                   '#b2df8a'],
		['Traditional Folk',                    '#33a02c'],
		['Big Band / Swing',                    '#fb9a99'],
		['Bop',                                 '#e31a1c'],
		['Cool',                                '#fdbf6f'],
		['Free Jazz',                           '#ff7f00'],
		['Fusion',                              '#cab2d6'],
		['Global Jazz',                         '#6a3d9a'],
		['Hard Bop',                            '#ffff99'],
		['Jazz Instrument',                     '#b15928'],
		['New Orleans / Classic Jazz',          '#a6cee3'],
		['Soul Jazz / Groove',                  '#1f78b4'],
		['Cuban Traditions',                    '#b2df8a'],
		['Latin America',                       '#33a02c'],
		['Mexican Traditions',                  '#fb9a99'],
		['Tropical',                            '#e31a1c'],
		['Alternative Rap',                     '#fdbf6f'],
		['Hip-Hop/Urban',                       '#ff7f00'],
		['International Rap',                   '#cab2d6'],
		['Pop-Rap',                             '#6a3d9a'],
		['Reggaeton/Latin Rap',                 '#ffff99'],
		['African Traditions',                  '#b15928'],
		['Asian Traditions',                    '#a6cee3'],
		['Brazilian Traditions',                '#1f78b4'],
		['Caribbean Traditions',                '#b2df8a'],
		['Celtic/British Isles',                '#33a02c'],
		['Central African',                     '#fb9a99'],
		['Central American Traditions',         '#e31a1c'],
		['Central European Traditions',         '#fdbf6f'],
		['Central/West Asian Traditions',       '#ff7f00'],
		['Chinese Traditions',                  '#cab2d6'],
		['East African',                        '#6a3d9a'],
		['Indian Subcontinent Traditions',      '#ffff99'],
		['Indonesian Traditions',               '#b15928'],
		['Japanese Traditions',                 '#a6cee3'],
		['Jewish Music',                        '#1f78b4'],
		['Mediterranean Traditions',            '#b2df8a'],
		['Middle Eastern Traditions',           '#33a02c'],
		['Nordic Traditions',                   '#fb9a99'],
		['North African',                       '#e31a1c'],
		['North American Traditions',           '#fdbf6f'],
		['North/East Asian Traditions',         '#ff7f00'],
		['Oceanic Traditions',                  '#cab2d6'],
		['Russian Traditions',                  '#6a3d9a'],
		['South American Traditions',           '#ffff99'],
		['South/Eastern European Traditions',   '#b15928'],
		['Southeast Asian Traditions',          '#a6cee3'],
		['Southern African',                    '#1f78b4'],
		['West African',                        '#b2df8a'],
		['Western European Traditions',         '#33a02c'],
		['Worldbeat',                           '#fb9a99'],
		['Contemporary R&B',                    '#e31a1c'],
		['Early R&B',                           '#fdbf6f'],
		['Soul',                                '#ff7f00'],
		['Cast Recordings',                     '#cab2d6'],
		['Film Music',                          '#6a3d9a'],
		['Sound Effects',                       '#ffff99'],
		['Television Music',                    '#b15928'],
		['Chicago Blues',                       '#a6cee3'],
		['Country Blues',                       '#1f78b4'],
		['Delta Blues',                         '#b2df8a'],
		['Early Acoustic Blues',                '#33a02c'],
		['East Coast Blues',                    '#fb9a99'],
		['Electric Blues',                      '#e31a1c'],
		['Jump Blues/Piano Blues',              '#fdbf6f'],
		['Louisiana Blues',                     '#ff7f00'],
		['Modern Electric Blues',               '#cab2d6'],
		['Texas Blues',                         '#6a3d9a'],
		['Alternative/Indie Rock',              '#ffff99'],
		['Art-Rock/Experimental',               '#b15928'],
		['Asian Pop',                           '#a6cee3'],
		['Asian Rock',                          '#1f78b4'],
		['British Invasion',                    '#b2df8a'],
		['Dance',                               '#33a02c'],
		['Europop',                             '#fb9a99'],
		['Folk/Country Rock',                   '#e31a1c'],
		['Foreign Language Rock',               '#fdbf6f'],
		['Hard Rock',                           '#ff7f00'],
		['Heavy Metal',                         '#cab2d6'],
		['Pop/Rock',                            '#6a3d9a'],
